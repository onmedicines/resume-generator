export default function Introduction({ intro, handleChange }) {
  return (
    <div className="intro-container">
      ...
      <main>
        <textarea rows={5} name="intro" placeholder="Highly creative and multi-talented Web Designer... " value={intro} onChange={handleChange}></textarea>
      </main>
    </div>
  );
}
